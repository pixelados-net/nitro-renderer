...
import { WiredCreatorToolsInspectComposer, WiredCreatorToolsInspectionEvent, WiredCreatorToolsMutationResultEvent, WiredCreatorToolsOpenEvent, WiredCreatorToolsRefreshComposer, WiredCreatorToolsSettingsUpdateComposer, WiredCreatorToolsSnapshotEvent, WiredCreatorToolsVariableUpdateComposer, WiredUserClickComposer } from './messages';
...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.WIRED_CREATOR_TOOLS_SNAPSHOT, WiredCreatorToolsSnapshotEvent);
        this._events.set(IncomingHeader.WIRED_CREATOR_TOOLS_MUTATION_RESULT, WiredCreatorToolsMutationResultEvent);
        this._events.set(IncomingHeader.WIRED_CREATOR_TOOLS_INSPECTION, WiredCreatorToolsInspectionEvent);
        this._events.set(IncomingHeader.WIRED_CREATOR_TOOLS_OPEN, WiredCreatorToolsOpenEvent);
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.WIRED_CREATOR_TOOLS_REFRESH, WiredCreatorToolsRefreshComposer);
        this._composers.set(OutgoingHeader.WIRED_CREATOR_TOOLS_VARIABLE_UPDATE, WiredCreatorToolsVariableUpdateComposer);
        this._composers.set(OutgoingHeader.WIRED_CREATOR_TOOLS_INSPECT, WiredCreatorToolsInspectComposer);
        this._composers.set(OutgoingHeader.WIRED_CREATOR_TOOLS_SETTINGS_UPDATE, WiredCreatorToolsSettingsUpdateComposer);
        this._composers.set(OutgoingHeader.WIRED_USER_CLICK, WiredUserClickComposer);
