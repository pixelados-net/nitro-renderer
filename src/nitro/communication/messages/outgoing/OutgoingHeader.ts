export class OutgoingHeader
{
    ...
    public static WIRED_CREATOR_TOOLS_REFRESH = 6300;
    public static WIRED_CREATOR_TOOLS_VARIABLE_UPDATE = 6301;
    public static WIRED_CREATOR_TOOLS_INSPECT = 6302;
    public static WIRED_CREATOR_TOOLS_SETTINGS_UPDATE = 6303;
    public static WIRED_USER_CLICK = 6304;
