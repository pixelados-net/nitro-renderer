...
export interface IConnectionCipher
{
    process(source: ArrayBuffer): ArrayBuffer;
}
...
export interface IConnection extends IEventDispatcher
{
    ...
    onReady(): void;
    authenticated(): void;
    setEncryption(clientToServer: IConnectionCipher, serverToClient?: IConnectionCipher): void;
